...
import huami.dev.bler.gatt.profile.AuthProfile;
...
public final class DeviceActivity extends Activity {
	...
	private AuthProfile m_Peripheral = null;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		m_Peripheral = new AuthProfile(this, device, new IConnectionStateChangeCallback() {
